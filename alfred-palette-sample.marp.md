...
style: |
  ...
  h2 { color: #feca57; margin-bottom: 0.4em; }
  h3 { color: #48dbfb; }
  strong { color: #feca57; }
  em { color: #48dbfb; font-style: normal; }
  code { background: #0f2040; color: #feca57; padding: 2px 6px; border-radius: 3px; border: 1px solid rgba(254, 202, 87, 0.3); }
  pre { background: #0f3460; border: 1px solid rgba(254, 202, 87, 0.2); border-radius: 6px; padding: 1em; }
  table { border-collapse: collapse; width: 100%; font-size: 0.85em; }
  th { background: #0f3460; color: #feca57; padding: 8px 14px; border: 1px solid rgba(254, 202, 87, 0.3); }
  td { border: 1px solid #2a2a4a; padding: 6px 14px; background: #1a1a2e; color: #e4e4e7; }
...
**Two modes — same identity, different engine:**
`Alfred-Anthropic` — full quality · `Alfred-NIM` — free-tier NVIDIA GLM-4.7
...
> *"Anthropas — human-centric. Argus — all-seeing. Alfred — always one step ahead."*

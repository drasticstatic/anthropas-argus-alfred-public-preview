...
|-------|---------|---------|
| `/startup` | "startup", "start session", "good morning" | Choose session backend, check proxy, read context |
| `/create-skill` | "create skill", "build skill for", "new skill" | Design a new skill for this repo |
| `/marp-deck` | "create a deck", "make slides", "marp this" | Convert any doc to a Marp slide deck |
...
- Content from specialist repos (trading, divorce, web3) — cross-repo privacy firewall
- Any content that belongs in `AGENT-SYNC/` or memory files
...
- Full dual-mode philosophy and NIM error protocol: `specs/alfred-workflow.md`
...
- Canonical public create-skill example: trading-assistant's `setup/create-skill.marp.html` (linked externally)

...
> `code/`, and Intent workspace paths — see [`INTENT_WORKTREE_LEGEND.md`](https://github.com/drasticstatic/anthropas-argus-alfred-public-preview/blob/main/sandbox/INTENT_WORKTREE_LEGEND.md)
